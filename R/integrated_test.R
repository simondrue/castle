...
#' Train integrated CASTLE model
#'
#' @param N_WT_only_vec
#' @param N_M_only_vec
#' @param N_d_neg_vec
#' @param N_d_pos_vec
#' @param abc_grid_resolution
#'
#' @return
#' @export
#'
...
estimate_r_integrated <- function(N_WT_only, N_M_only, N_d_neg, N_d_pos,
                                  l_est,
                                  model) {
  abc_grid <- model$abc_grid
  abc_grid_train_log_lik <- model$abc_grid_train_log_lik
...
#' Test sample using integrated CASTLE model
#'
#' @param test_samples
#' @param model
#' @param include_r_confidence_interval,include_l_confidence_interval
#' @param alpha
#'
#' @return
#' @export
